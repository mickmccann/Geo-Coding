...
API_KEY = 'AIzaSyC90x5OJkeN7TVgM2tocSIDxXb5t0KKPMw'
...
def get_google_results(address, api_key='AIzaSyC90x5OJkeN7TVgM2tocSIDxXb5t0KKPMw', return_full_response=False):
    """
